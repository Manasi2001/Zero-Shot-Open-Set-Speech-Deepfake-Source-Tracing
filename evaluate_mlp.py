...
# Paths
# ==============================
model_path = 'mlp_results_SSL_AASIST_AAM_RegMixup/best_epoch_97_min_val_loss.pth'
scaler_path = 'mlp_results_SSL_AASIST_AAM_RegMixup/scaler.pkl'
fingerprint_file = 'fingerprint_all_emb_SSL_AASIST_AAM_RegMixup.csv'
trial_embeddings_file = 'trial_embeddings_SSL_AASIST_AAM_RegMixup.npy'
trial_list_file = 'protocols_trials_extended/AA01-co-100_trials.txt'
protocols_folder = 'protocols_trials_extended'
output_file = 'evaluation_files_with_scores/evaluation_mlp_SSL_AASIST_AAM_RegMixup.csv'
...
for file_name in os.listdir(protocols_folder):
    # if file_name.endswith('.txt') and any(k in file_name for k in ['AA01', 'AA03', 'AA05', 'AA07', 'AA10']):
