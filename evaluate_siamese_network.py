...
# 3. Load checkpoint
net.load_state_dict(torch.load("models/zero_shot_siamese_network_CL_SSL_AASIST_AAM_RegMixup.pt", map_location=device))
net.to(device).eval()
...
# -------------------------------
fingerprint_df = pd.read_csv("fingerprint_all_emb_SSL_AASIST_AAM_RegMixup.csv")
...
# -------------------------------
trial_embeddings = np.load("trial_embeddings_SSL_AASIST_AAM_RegMixup.npy") 
...
output_file = 'evaluation_files_with_scores/evaluation_zero_shot_siamese_network_CL_SSL_AASIST_AAM_RegMixup.csv'
