"""
USE FOR TRAINING SIAMESE NETWORK WITH CONTRASTIVE LOSS FOR FEW-SHOT SCENERIO
...
# -------------------------------
df = pd.read_csv("fingerprint_all_emb_SSL_AASIST_AAM_RegMixup.csv")
...
if __name__ == "__main__":
    ...
    torch.save(
        model.state_dict(),
        "models/few_shot_siamese_network_CL_SSL_AASIST_AAM_RegMixup.pt"
    )
